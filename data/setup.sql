...
LOAD DATA LOCAL INFILE '/Users/jodie/Desktop/School/Spring 2021/Databases/Country.csv' INTO TABLE Country 
        FIELDS OPTIONALLY ENCLOSED BY '"'
        TERMINATED BY ',' 
        LINES TERMINATED BY '\r\n'
        (Continent,CountryName,Government,CountryCode,Region,IncomeGroup);
        
LOAD DATA LOCAL INFILE '/Users/jodie/Desktop/School/Spring 2021/Databases/Country_Info.csv' INTO TABLE CountryInfo
        FIELDS OPTIONALLY ENCLOSED BY '"'
        TERMINATED BY ',' 
        LINES TERMINATED BY '\r\n'
        IGNORE 1 LINES 
...
LOAD DATA LOCAL INFILE '/Users/jodie/Desktop/School/Spring 2021/Databases/Disease.csv' INTO TABLE Disease
        FIELDS OPTIONALLY ENCLOSED BY '"'
        TERMINATED BY ',' 
        LINES TERMINATED BY '\r\n'
        IGNORE 1 LINES 
...
LOAD DATA LOCAL INFILE '/Users/jodie/Desktop/School/Spring 2021/Databases/Has-Disease.csv' INTO TABLE HasDisease
        FIELDS OPTIONALLY ENCLOSED BY '"'
        TERMINATED BY ',' 
        LINES TERMINATED BY '\r\n'
        IGNORE 1 LINES 
...
LOAD DATA LOCAL INFILE '/Users/jodie/Desktop/School/Spring 2021/Databases/Mortality-Rate.csv' INTO TABLE MortalityRate
        FIELDS OPTIONALLY ENCLOSED BY '"'
        TERMINATED BY ',' 
        LINES TERMINATED BY '\r\n'
        IGNORE 1 LINES 
...
LOAD DATA LOCAL INFILE '/Users/jodie/Desktop/School/Spring 2021/Databases/Vaccination.csv' INTO TABLE Vaccination
        FIELDS OPTIONALLY ENCLOSED BY '"'
        TERMINATED BY ',' 
        LINES TERMINATED BY '\r\n'
        IGNORE 1 LINES 
...
LOAD DATA LOCAL INFILE '/Users/jodie/Desktop/School/Spring 2021/Databases/Vaccination-Drive.csv' INTO TABLE VaccinationDrive
        FIELDS OPTIONALLY ENCLOSED BY '"'
        TERMINATED BY ',' 
        LINES TERMINATED BY '\r\n'
        IGNORE 1 LINES 
