...
echo "<h2 style=\"text-align:center\">Government Disease</h2>";

//Determine if any input was actually collected
if (empty($year) or empty($dis)) {
   echo "empty <br><br>";

} else {

   echo "<h3 style=\"text-align:center\">Percentage of population in different types of governments that suffered from ".$dis." in ".$year."</h3></br>";
