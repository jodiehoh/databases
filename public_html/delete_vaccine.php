...
if (isset($_POST['vaccine6'])) {
    $vaccine = $_POST['vaccine6'];
}



echo "<h2 style=\"text-align:center\">Delete Vaccination</h2>";
...
if (empty($vaccine)) {
   ...
   echo "<h3 style=\"text-align:center\">".$vaccine."</h3></br>";

   echo "<br><br>";
   //Prepare a statement that we can later execute. The ?'s are placeholders for
   //parameters whose values we will set before we run the query.
   if ($stmt = $conn->prepare("CALL DeleteVaccination(?)")) {
